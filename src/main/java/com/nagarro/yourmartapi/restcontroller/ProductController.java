...
public class ProductController {
	...
	public void addProduct(@RequestBody Product product, @RequestHeader(value = "authentication") String token) {
		try {
	...
	public void deleteProduct(@PathVariable("id") int id, @RequestHeader(value = "authentication") String token) {
